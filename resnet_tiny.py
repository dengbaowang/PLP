...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet110', 'resnet152', 'Linear']
...
# }
models_dir = os.path.expanduser('./pretrained_models/')
model_name = {
...
def resnet110(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load(os.path.join(models_dir, model_name['resnet1100'])))
    return model
